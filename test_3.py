...
def attributes(place_p_ID,id,street_address,locality,region,iso3,postal_code,phone,twitter,url):
    ...
    cursor = db.cursor()
    insert_query = "INSERT INTO place (place_p_ID,id,street_address,locality,region,iso3"                    ",postal_code,phone,twitter,url) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
...
def tweet_data(id,place_p_ID,u_id,contributors, created_at,favorite_count
    ...
    cursor = db.cursor()
    insert_query = "INSERT INTO tweet (id,place_p_ID,u_id,contributors, created_at,favorite_count,"                   "favorited,filter_level,geo,id_str,in_reply_to_screen_name,in_reply_to_status_id"                    ",in_reply_to_status_id_str, in_reply_to_user_id, in_reply_to_user_id_str"                   ",lang,retweet_count,retweeted,source,text,timestamp_ms,truncated,possibly_sensitive"                    ",withheld_copyright,withheld_countries,time_stamp"                   ",withheld_scope) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    cursor.execute(insert_query, (id,place_p_ID,u_id,contributors, created_at,favorite_count
                ,favorited,filter_level,geo,id_str,in_reply_to_screen_name,in_reply_to_status_id
                ,in_reply_to_status_id_str, in_reply_to_user_id, in_reply_to_user_id_str
                ,lang,retweet_count,retweeted,source,text,timestamp_ms,truncated,possibly_sensitive
                ,withheld_copyright,withheld_countries,withheld_scope,time_stamp))
...
def user_data(u_id,tweet_id,contributors_enabled,created_at,default_profile,
    ...
    cursor = db.cursor()
    insert_query = "INSERT INTO user(u_id,tweet_id"                   ",contributors_enabled,created_at,default_profile"                    ",default_profile_image,description,favourites_count,follow_request_sent,"                    "followers_count,following,friends_count,geo_enabled,id_str,"                    "is_translator,lang,listed_count,location,name,notifications,"                    "profile_background_color,profile_background_image_url,"                    "profile_background_image_url_https,profile_background_tile,"                    "profile_banner_url,profile_image_url,profile_image_url_https,"                    "profile_link_color,profile_sidebar_border_color,"                    "profile_sidebar_fill_color,profile_text_color,profile_use_background_image,"                    "protected,screen_name,show_all_line_media,"                    "statuses_count,time_zone,url,utc_offset,"                    "verified,withheld_countries,withheld_scope,"                    "flag ) VALUES (%s,%s,%s,%s, %s,%s,%s,%s"                    ", %s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s,"                    " %s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s"                    ", %s,%s,%s,%s, %s,%s,%s)"
...
def contributors(tweet_id,id,id_str,screen_name):
    db = pymysql.connect(host=HOST, user=USER, passwd=PASSWD, db=DATABASE, charset="utf8mb4")
	#establishing connection to database
    cursor = db.cursor()
...
def user_mentions(entities_tweet_id,id,id_str,screen_name,name,indices):
	...
	#establishing connection to database
    cursor = db.cursor()
    insert_query = "INSERT INTO tweet (entities_tweet_id,id,id_str"    ",screen_name,name,indices) VALUES (%s,%s,%s,%s,%s,%s)"
...
def hashtag(entities_tweet_id,no,indices,text,indices2):
	...
	#establishing connection to database
    cursor = db.cursor()
    insert_query = "INSERT INTO tweet (entities_tweet_id,no,indices"    ",text,indices2) VALUES (%s,%s,%s,%s,%s)"
...
def url(urls_url,urls_user_u_id,urls_user_tweet_id,expanded_url,indices,display_url):
	...
	#establishing connection to database
    cursor = db.cursor()
    insert_query = "INSERT INTO tweet (urls_url,urls_user_u_id,urls_user_tweet_id"                   ",expended_url,indices,display_url) VALUES (%s,%s,%s,%s,%s,%s)"
...
def media(m_id,entities_tweet_id,id_str,media_url,media_url_https,url,display_url,expanded_url,source_status_id,source_status_is_str
	...
	#establishing connection to database
    cursor = db.cursor()
    insert_query = "INSERT INTO tweet (m_id,entities_tweet_id,id_str,media_url,media_url_https,url,display_url,expanded_url"                                      ",source_status_id,source_status_is_strtype,indices,resize,title"                                      ",description,embeddable,monetizable) VALUES (%s,%s,%s,%s"                                          ", %s,%s,%s,%s, %s,%s,%s,%s, %s,%s,%s,%s, %s)"
...
def on_data(self, data):
    ...
    try:
        ...
        contributors=str(dictData["contributors"])
        ...
        tweet_data(id,place_p_ID,u_id,contributors, created_at,favorite_count
           , favorited,filter_level,geo,id_str,in_reply_to_screen_name,in_reply_to_status_id
           ,in_reply_to_status_id_str, in_reply_to_user_id, in_reply_to_user_id_str
           ,lang,retweet_count,retweeted,source,text,timestamp_ms,truncated,possibly_sensitive
           ,withheld_copyright,withheld_countries,withheld_scope,time_stamp):
        ...
        if(contributors!="null"):
            id=str(dictData["contributors"]["id"])
            id_str=str(dictData["contributors"]["id_str"])
            screen_name=str(dictData["contributors"]["screen_name"])



            ########################coordinates###############################
            tweet_id=str(dictData["id"])
            coordinates=(dictData["place"]["bound_box"])
            place_type=str(dictData["place"]["place_type"])
